  ...
  return (
    <div className="bg-gray-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="mb-4">
          This privacy policy sets out how our website uses and protects any information that you give us when you use this
          website.
        </p>
        ...
        <p className="mb-4">
          ...
          not governed by this privacy statement. You should exercise caution and look at the privacy statement applicable
